...
public class UndoableAddLocationCoordinates extends AbstractUndoableEdit{
    ...
    private final SVGConjurer svgc;
    ...
    JSVGCanvas canvas;
    public UndoableAddLocationCoordinates(final SVGConjurer svgc, Element coord_X, Element coord_Y){
        location_name = "";
        this.svgc = svgc;
...
//        System.out.println("Came into the UndoableAddLocationCoordinates");
        ...
        Runnable r = new Runnable(){
            public void run(){
                svgc.document.getDocumentElement().insertBefore(coord_x, svgc.this_side);
                svgc.document.getDocumentElement().insertBefore(coord_y, svgc.this_side);

                location_coordinates_list.add(coord_x);
                location_coordinates_list.add(coord_y);
            }
        };
        svgc.update_manager.getUpdateRunnableQueue().invokeLater(r);
    }
