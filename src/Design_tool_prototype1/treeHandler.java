...
//        System.out.println("**********The ui is "+ui.toString());
    ...
    public void refreshTree(projectObject po, ribbonTest rt){
        System.out.println("Refresh tree called");
        updateTree(po);
    ...
    public void mouseClicked(MouseEvent e){
        ...
        if(selPath!=null){
            ...
            try{
                ...
                System.out.println("treeHandler MouseClicked Check point 01");
                System.out.println("The Element by name is: "+clicked_element.getAttribute("id"));
                rt.selectedSVGC.setSelectedDrawing(clicked_element);
                System.out.println("treeHandler MouseClicked Check point 02");
                rt.selectedSVGC.refresh();
                System.out.println("treeHandler MouseClicked Check point 03");

                System.out.println("treeHandler MouseClicked Check point 04");
                if(clicked_element.getLocalName().equals("text")){
                    System.out.println("treeHandler MouseClicked Check point 05");
                    rt.text_type_area.setText(clicked_element.getFirstChild().getFirstChild().getTextContent());
                    System.out.println("treeHandler MouseClicked Check point 06");
                    rt.getRibbon().setSelectedTask(rt.getRibbon().getTask(4));
                    System.out.println("treeHandler MouseClicked Check point 07");
                    rt.selectedSVGC.selected_text = clicked_element;
                    System.out.println("treeHandler MouseClicked Check point 08");
                    rt.selectedSVGC.selected_shape = null;
                    System.out.println("treeHandler MouseClicked Check point 09");
                }

                else if(clicked_element.getLocalName().equals("path")){
                    System.out.println("treeHandler MouseClicked Check point 10");
                    rt.getRibbon().setSelectedTask(rt.getRibbon().getTask(0));
                    System.out.println("treeHandler MouseClicked Check point 11");
                    rt.selectedSVGC.textPath = false;
                    System.out.println("treeHandler MouseClicked Check point 12");
                }
            }
            catch(Exception e2){
