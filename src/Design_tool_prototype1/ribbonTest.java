...
increaseSplash();
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            ...
            System.out.println("ribbon test ActionPerformed Exception");
        }
...
//            patternObject po = new patternObject();
            try{
                ...
                System.out.println("Could not close the project");
            }
...
//            System.out.println("The Exception is "+e);
            ...
            if(jtb.getName().contains("fabric")){
                ...
                selectedSVGC.fillPatternByURI(fabrics_list.get(bt_num).getFabricNameLong());
            }
